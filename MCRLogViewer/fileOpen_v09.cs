    ...
    partial class frmMain
    {
		...
		public void fileOpen_v09(){
			...
			while (WorkAddress < fileSize - 512){
				...
				l.gyroEx	= (sbyte)buf[WorkAddress + BuffAddress + 14];
				l.gyro		= (sbyte)buf[WorkAddress + BuffAddress + 15];
				l.floor		= (sbyte)buf[WorkAddress + BuffAddress + 16];
				l.side		= l.slope_sw;
				...
				str.Append(String.Format("{0, 5}", l.vt));
				...
				str.Append(String.Format("{0, 3}", l.gyroEx));
